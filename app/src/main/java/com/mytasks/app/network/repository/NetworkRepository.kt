package com.mytasks.app.network.repository

import com.mytasks.app.R
import com.mytasks.app.appcomponents.di.MyApp
import com.mytasks.app.extensions.NoInternetConnection
import com.mytasks.app.extensions.isOnline
import com.mytasks.app.network.RetrofitServices
import com.mytasks.app.network.models.createlogin.CreateLoginRequest
import com.mytasks.app.network.models.createlogin.CreateLoginResponse
import com.mytasks.app.network.models.createregister.CreateRegisterRequest
import com.mytasks.app.network.models.createregister.CreateRegisterResponse
import com.mytasks.app.network.models.fetchme.FetchMeResponse
import com.mytasks.app.network.resources.ErrorResponse
import com.mytasks.app.network.resources.Response
import com.mytasks.app.network.resources.SuccessResponse
